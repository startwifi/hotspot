...
class SMSC
	...
	SMSC_LOGIN = Rails.application.secrets.smsc_login			# логин клиента
	SMSC_PASSWORD = Rails.application.secrets.smsc_password	# пароль или MD5-хеш пароля в нижнем регистре
